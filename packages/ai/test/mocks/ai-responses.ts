export const mockAIResponses = {
  ...
  bau: {
    ...
    roles: [
      { name: "TANK", count: 1, preAssignedUser: "@BardosaKing" },
      { name: "PUTRIDO", count: 1, preAssignedUser: "@Dominickss" },
      { name: "HEALER", count: 1, preAssignedUser: "@Renatinha" },
      { name: "ARTICO", count: 1, preAssignedUser: "@NightHuntersx" },
      { name: "CANÇÃO", count: 1, preAssignedUser: "@Lilith" },
      { name: "FURA BRUMA", count: 1, preAssignedUser: "@Graiken" },
      { name: "STOPPER", count: 1, preAssignedUser: "@yRegulus" },
    ],
    maxParticipants: 7,
  ...
  bauDourado: {
    ...
    roles: [
      { name: "Tank", count: 1, preAssignedUser: "@hana" },
      { name: "Sagrado", count: 1, preAssignedUser: "@Metagrosszzen" },
      { name: "Pútrido", count: 1, preAssignedUser: "Batman" },
      { name: "Para-Tempo", count: 1, preAssignedUser: "@SiriiusBeck" },
      { name: "FB", count: 1, preAssignedUser: "@LeGuiH" },
      { name: "FB (mana)", count: 1, preAssignedUser: "@NatusVincere10" },
      { name: "Canção", count: 1, preAssignedUser: "@Renatinha" },
    ],
    maxParticipants: 7,
