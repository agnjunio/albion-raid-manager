        ...
        {isEditing ? (
          <div className="space-y-4">
            <Textarea
              ...
              placeholder={t("raids.notes.placeholder")}
          ...
          <div className="flex flex-col items-center justify-center py-8 text-center">
            ...
            <h3 className="text-muted-foreground mb-2 text-lg font-semibold">{t("raids.notes.noNotes")}</h3>
            <p className="text-muted-foreground mb-4 text-sm">{t("raids.notes.noNotesDescription")}</p>
            <Button variant="outline" size="sm" onClick={() => setIsEditing(true)}>
              <FontAwesomeIcon icon={faEdit} className="mr-2 h-4 w-4" />
              {t("raids.notes.addNotes")}
            </Button>
          </div>
        )}
      </CardContent>
